...
for i = 1;
    for rep = 0:3;
        for pole = 0:30:330;
            ...
            pattern_names{count} = sprintf('step_ptch_roll_%d_v%d_rep%d.mat',pole,i,rep);
            count = count + 1;
        end
    end
end
...
for pnum = 1:48;
    ...
    directory_name = 'E:\flight-muscles\experimental\00_squadrons\18_step_pitch_roll\design\stimulus_data';
