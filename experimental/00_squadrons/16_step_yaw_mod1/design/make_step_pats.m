...
for i = 1;
    for rep = 0:4;
        pattern_names{count} = sprintf('step_yaw_90_v%d_rep%d.mat',i,rep);
        count = count + 1;
    end
end
...
for i = 1;
    for rep = 0:4;
        pattern_names{count} = sprintf('step_yaw_270_v%d_rep%d.mat',i,rep);
        count = count + 1;
    end
end
...
% for i = 1;
%     for rep = 0:4;
%         pattern_names{count} = sprintf('step_trans_for_v%d_rep%d.mat',i,rep);
%         count = count + 1;
%     end
% end
% 
% for i = 1;
%     for rep = 0:4;
%         pattern_names{count} = sprintf('step_trans_back_v%d_rep%d.mat',i,rep);
%         count = count + 1;
%     end
% end
% 
% for i = 1;
%     for rep = 0:4;
%         pattern_names{count} = sprintf('step_trans_up_v%d_rep%d.mat',i,rep);
%         count = count + 1;
%     end
% end
% 
% for i = 1;
%     for rep = 0:4;
%         pattern_names{count} = sprintf('step_trans_down_v%d_rep%d.mat',i,rep);
%         count = count + 1;
%     end
% end
...
for pnum = 1:20;
    ...
    directory_name = 'E:\flight-muscles\experimental\00_squadrons\16_step_yaw_mod1\design\stimulus_data';
